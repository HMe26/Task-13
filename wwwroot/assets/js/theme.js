...
var themeControl = function themeControl() {
  ...
  themeController.on('click', function (e) {
    var controlEl = e.target.closest ? e.target.closest('[data-theme-control]') : e.target;
    var target = new DomNode(controlEl);
    if (controlEl && target.data('theme-control')) {
      var control = target.data('theme-control');
      var value = controlEl[controlEl.type === 'checkbox' ? 'checked' : 'value'];
      if (control === 'theme') {
